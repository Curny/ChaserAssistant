...
namespace ChaserAssistant
{
    ...
    public partial class Dwd
    {
        public static Dwd FromJson(string json) => JsonConvert.DeserializeObject<Dwd>(json, ChaserAssistant.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Dwd self) => JsonConvert.SerializeObject(self, ChaserAssistant.Converter.Settings);
    }
